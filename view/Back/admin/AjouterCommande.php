<?php
  ...
  include '../../../controller/PanierC.php';
    ...
    if(isset($_GET['idPanier'])){
      $panier = $PanierC->RecupererPanier($_GET['idPanier']);
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-7">
                        <div class="rounded h-100 p-4">
                            <center><h4 class="mb-4">Ajouter Commande</h4></center>
                            <form method="POST" class="forms-sample" name="form" id="form" enctype="multipart/form-data" onsubmit="return validateForm();">
                                ...
                                <div class="mb-3">
                                    <label for="prix" class="form-label">Ville</label>
                                ...
                                <a href="AfficherCommandes.php" class="btn btn-light">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
